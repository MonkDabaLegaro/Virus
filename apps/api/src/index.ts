...
app.post('/api/telemetry/import/windows',async(req,reply)=>{
  ...
  return reply.code(200).send(await telemetry.importWindows({scenarioId:scenario.id,observations:body.observations}));
});
